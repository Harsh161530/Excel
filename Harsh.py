...
#Open the CSV file 
reader = csv.reader(open('D:\\Semester 3\\Data visualization\\Assignment 4\\Largest_Cities_CSV(1).csv'),delimiter="," )
...
#In case the population value is nil, do not append the record in the last
							if j ==2:
								if item[i+2] == '':
...
mycsv = csv.writer(open('D:\\Semester 3\\Data visualization\\Assignment 4\\Harsh.csv', 'wb'))
for row in list1:
